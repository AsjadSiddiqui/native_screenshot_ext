...
- Removed dependency on deprecated FlutterView
- Improved bitmap capture method for compatibility with latest Flutter versions
- Updated to support Dart SDK 3.7.0 and later

## 1.2.6

- Updated SDK constraints to support Dart 3 and 4
- Improved compatibility with the latest Flutter versions
